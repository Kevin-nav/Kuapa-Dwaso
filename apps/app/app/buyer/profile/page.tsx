...
import { LogOut, CheckCircle, ShieldAlert, Edit3, Phone, Building, MapPin } from "lucide-react";
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px", fontSize: "0.9375rem" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              ...
              <strong style={{ color: "var(--color-ink)" }}>{organizationName}</strong>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              ...
              <strong style={{ color: "var(--color-ink)" }}>{destinationMarket}</strong>
            </div>
          </div>
