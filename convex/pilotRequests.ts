...
function requestSummary(request: Doc<"pilotBuyerRequests">) {
  return {
    ...
    maizeType: request.maizeType,
    requestedGrams: request.requestedGrams,
    confirmedGrams: request.confirmedGrams,
    commercialMode: request.commercialMode,
    destination: request.destination,
    deliveryWindowStartAt: request.deliveryWindowStartAt,
    deliveryWindowEndAt: request.deliveryWindowEndAt,
    requestedSpecification: request.requestedSpecification,
    paymentExpectation: request.paymentExpectation,
