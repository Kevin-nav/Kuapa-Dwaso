...
const registrationSource = v.union(
  v.literal("self_app"),
  v.literal("agent_assisted"),
  v.literal("admin"),
);
...
const blogContentBlock = v.union(
  v.object({
    ...
    content: v.array(blogTextSegment),
  }),
  v.object({
    id: v.string(),
    type: v.union(v.literal("bulletList"), v.literal("numberedList")),
    items: v.array(v.array(blogTextSegment)),
  }),
  v.object({
    id: v.string(),
...
export default defineSchema({
  ...
  blogPosts: defineTable({
    ...
    status: blogStatus,
    content: v.array(blogContentBlock),
    ...
    .index("by_category_status_published_at", [
      "category",
      "status",
      "publishedAt",
    ])
  ...
  farmers: defineTable({
    ...
    .index("by_preferred_warehouse_verification_status", [
  ...
  storageRateRules: defineTable({
    ...
    .index("by_warehouse_status_effective", [
      "warehouseId",
      "status",
      "effectiveFrom",
    ])
  ...
  inventoryBatches: defineTable({
    ...
    .index("by_warehouse_crop_grade_status", [
      "warehouseId",
      "cropType",
      "grade",
      "status",
  ...
  marketDeliveryRuns: defineTable({
    ...
    .index("by_warehouse_status_date", [
      "originWarehouseId",
      "status",
      "deliveryDateAt",
    ])
    .index("by_destination_status_date", [
      "destinationName",
      "status",
      "deliveryDateAt",
    ])
  ...
  dispatches: defineTable({
    ...
    .index("by_warehouse_destination_status", [
      "warehouseId",
      "destination",
      "status",
    ]),
  ...
  notifications: defineTable({
    ...
    .index("by_status", ["status"])
    .index("by_recipient_deduplication", [
      "recipientUserId",
      "deduplicationKey",
    ])
    .index("by_market_delivery_run", ["marketDeliveryRunId"])
  ...
  smsDeliveries: defineTable({
    ...
    .index("by_provider_message_recipient", [
      "provider",
      "providerMessageId",
      "recipient",
    ])
